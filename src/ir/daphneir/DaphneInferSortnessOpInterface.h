...
#ifndef SRC_IR_DAPHNEIR_DAPHNEINFERSORTNESSOPINTERFACE_H
#define SRC_IR_DAPHNEIR_DAPHNEINFERSORTNESSOPINTERFACE_H
...
#include <ir/daphneir/DaphneInferSortnessOpInterface.h.inc>
}
 ...
 * @return
 */
std::vector<MatrixSortness> tryInferSortness(mlir::Operation *op);
} // namespace mlir::daphne

#endif // SRC_IR_DAPHNEIR_DAPHNEINFERSORTNESSOPINTERFACE_H