...
namespace mlir::daphne {
/**
 * @brief Tries to infer min and max value of the results of the given operation.
 *
 ...
 * @return
 */
 std::vector<std::pair<std::optional<double>, std::optional<double>>> tryInferMinMax(mlir::Operation *op);
} // namespace mlir::daphne
